...
/*
GLOBAL.feature = jasmine.grammar.FeatureStory.feature;
GLOBAL.scenario = jasmine.grammar.FeatureStory.scenario;
GLOBAL.story = jasmine.grammar.FeatureStory.story;

GLOBAL.and = jasmine.grammar.GWT.and;
GLOBAL.given = jasmine.grammar.GWT.given;
GLOBAL.when = jasmine.GWT.when;
GLOBAL.then = jasmine.grammar.GWT.then;
*/
