...
var $AnimateProvider = ['$provide', function($provide) {
  ...
  this.$get = ['$$q', '$$asyncCallback', '$rootScope', function($$q, $$asyncCallback, $rootScope) {
    ...
    return {
       ...
       * @return {Bluebird} the animation callback promise
       */
 ...
 *
 * @returns {Bluebird} The newly created promise.
 */
function $QProvider() {
...
function qFactory(nextTick, exceptionHandler) {
   ...
   *
   * @param {Array.<Bluebird>|Object.<Bluebird>} promises An array or hash of promises.
   * @returns {Bluebird} Returns a single promise that will be resolved with an array/hash of values,
 ...
 *
 * @return {Bluebird} the HTTP Promise for the given.
 *
...
function $TimeoutProvider() {
  this.$get = ['$rootScope', '$browser', '$q', '$$q', '$exceptionHandler',
    ...
    var deferreds = {};
      ...
      * @param {boolean=} [invokeApply=true] If set to `false` skips model dirty checking, otherwise
      *   will invoke `fn` within the {@link ng.$rootScope.Scope#$apply $apply} block.
      * @returns {Bluebird} Promise that will be resolved when the timeout is reached. The value this
    ...
    function timeout(fn, delay, invokeApply) {
      ...
      * resolved with a rejection.
      *
      * @param {Bluebird=} promise Promise returned by the `$timeout` function.
      * @returns {boolean} Returns `true` if the task hasn't executed yet and was successfully
      *   canceled.
      */
