...
Hovering over a region will display an empty rectangle where new includes may be added. Hovering over this rectangle 
will reveal an <i>Add include</i> button. 
